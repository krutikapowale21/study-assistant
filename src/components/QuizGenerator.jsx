...
export default function QuizGenerator() {
  ...
  const generateQuiz = async () => {
    ...
    setSubmitted(false);
    try {
      const raw = await askGroq(`You are a quiz generator. Based on the following study material, generate exactly ${numQ} multiple choice questions at ${difficulty} difficulty.

Return ONLY a valid JSON array, no markdown, no explanation, no backticks. Format:
[
  {
    ...
    <div>
      {!quiz.length && (
        <div className="card">
          ...
          <div className="card-sub">Upload a TXT file or paste your study notes — AI will generate a quiz instantly.</div>
          ...
          >
            ...
            <div className="upload-text">
              <strong>Click or drag</strong> to upload TXT file<br />
              <span style={{ fontSize: "11px" }}>Plain text files only</span>
            </div>
